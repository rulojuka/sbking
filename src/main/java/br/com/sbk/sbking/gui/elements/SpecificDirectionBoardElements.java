...
public class SpecificDirectionBoardElements {
    ...
    public SpecificDirectionBoardElements(Direction direction, Deal deal, Container container,
        ...
        for (Direction currentDirection : Direction.values()) {
            ...
            new HandElement(deal, container, actionListener, FrameConstants.pointOfDirection.get(currentDirection),
        ...
        new AcceptClaimElement(deal.getClaimer(), direction, deal.getIsPartnershipGame(), deal.getAcceptedClaimMap(),
                container, new Point(container.getWidth() - 150, container.getHeight() - 50), actionListener);

        new RejectClaimElement(deal.getClaimer(), direction, deal.getIsPartnershipGame(), deal.getAcceptedClaimMap(),
                container, new Point(container.getWidth() - 150, container.getHeight() - 50), actionListener);
